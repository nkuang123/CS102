 ...
 * a ball that bounces off all 4 walls
 *
 */
public class PaddlePart4 extends JPanel implements ActionListener {
    ...
    private int xChange = -4, yChange = 4;
    ...
    public void drawFrame(Graphics g) {
        if (inPlay) {
            ...
            g.drawString("Game over. Close window to quit.", WINDOW_WIDTH / 4, WINDOW_HEIGHT / 2);
        }
        /**
    ...
    public void checkForPaddleHit() {
        if ((xPos >= paddleX) && ((xPos + DIAMETER) <= (paddleX + PADDLE_WIDTH))
                && ((yPos + DIAMETER) >= PADDLE_Y) && (yChange > 0)) {
            yChange *= -1;
        }
    }
     ...
     */
    public void setup(PaddlePart4 drawingArea) {
         ...
         *
         * Implement the MouseMoved method to move the paddle. This means
    ...
    public static void main(String[] args) {
        ...
        PaddlePart4 da = new PaddlePart4();
        da.setup(da);
    }
