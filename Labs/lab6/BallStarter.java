 ...
 * 
 */
public class BallStarter extends JPanel implements ActionListener {
     ...
     */
    public void setup(BallStarter drawPanel) { 
     ...
     * instantiates a BallStarter and passes this
     * variable to the setup method. This works
     * because an instance method is being called
     * on an object of type BallStarter.
     */
    public static void main(String[] args) {
        BallStarter drawingArea = new BallStarter();
