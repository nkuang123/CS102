...
// TASK 2: Import the java package that contains the JOption
// class for reading input (you will probably need to google
// <JOption java API> to find it). Write the import statement
...
public class AddABCDv2 { 
  ...
  public static void main(String[] args) {
    ...
    tempA = JOptionPane.showInputDialog("Please enter value a : "); // these should be replaced with 
    tempB = JOptionPane.showInputDialog("Please enter value b : "); // .nextLine() method calls to the
    tempC = JOptionPane.showInputDialog("Please enter value c : "); // Scanner object created for TASK 3. 
    tempD = JOptionPane.showInputDialog("Please enter value d : ");
